...
# DAVx5 battery optimization exemptions for proper sync
PRODUCT_COPY_FILES += \
    vendor/lineage/overlay/common/etc/sysconfig/davx5-sysconfig.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/davx5-sysconfig.xml
